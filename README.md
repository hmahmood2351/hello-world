...
Keeping it simple, the requirement is to configure multiple devices on the topology below (showing a LAN at a branch site) with the MOTD (message of the day) banner being set to "Hello World!".
